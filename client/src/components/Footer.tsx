    ...
    <footer className="bg-primary text-primary-foreground pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 text-teal-100">
                ...
                <a
                  href="mailto:contact@amandine-guide.fr"
              ...
              <div className="flex items-center space-x-3 text-teal-100">
                ...
                <a href="tel:+33600000000" className="hover:text-white">
                  +33 6 00 00 00 00
                </a>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-teal-200 text-sm">
          <p>
            &copy; {new Date().getFullYear()} Amandine Guide Conférencière.{" "}
            {t("footer.rights")}.
          </p>
