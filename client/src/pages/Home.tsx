          ...
          <div className="w-full lg:w-1/2 z-10 space-y-8 text-center lg:text-left">
            ...
            >
              <Link href="/tours">
                <Button
                  size="lg"
                  className="text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
                >
                  {t("hero.cta.tours")}
                </Button>
              </Link>
              <Link href="/contact">
                <Button
                  variant="outline"
                  size="lg"
                  className="text-lg px-8 py-6 border-2 rounded-xl hover:bg-teal-50 hover:text-primary transition-all"
                >
                  {t("hero.cta.contact")}
                </Button>
              </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-end mb-12">
              ...
              <Link href="/tours">
                <Button
                  variant="ghost"
                  className="hidden sm:flex items-center text-secondary hover:text-primary hover:bg-transparent p-0 font-bold"
                >
                  {t("home.featured.all")}{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredTours.map((tour) => (
                <Link
                  key={tour.id}
                  href={`/contact?subject=${encodeURIComponent(tour.title)}`}
                  ...
                  <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col border border-gray-100">
                    <div className="relative h-64 overflow-hidden">
                      <img
                        src={
                          tour.imageUrl ||
                          "https://images.unsplash.com/photo-1594910086877-c371f49646b9?w=800&auto=format&fit=crop&q=60"
                        }
                        alt={tour.title}
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="flex justify-between items-center text-sm font-medium pt-4 border-t border-gray-100">
                        <span className="text-secondary">
                          {tour.duration || "Demi-journée"}
                        </span>
                        <span className="text-primary font-bold">
                          {tour.price || "Sur devis"}
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {displayTestimonials.map((testimonial) => (
              ...
              >
                <div className="text-accent text-6xl font-serif absolute top-4 left-4 opacity-20">
                  "
                </div>
              ...
              <>
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 italic mb-6 relative z-10">
                      "Une visite exceptionnelle ! Amandine connait Lyon comme
                      sa poche et ses anecdotes ont rendu l'histoire vivante."
                    </p>
                    <div className="font-bold text-primary font-display">
                      — Client heureux
                    </div>
